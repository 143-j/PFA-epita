...
typedef struct{
  char name[20]; /* Name of the quadrature formula. */
   ...
   double wk[5]; /* We will use at most 5 weights */
   double xk[5];/* Add here other paramaters to the structure definition, that you may need for the integral function */
